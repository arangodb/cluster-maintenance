...
exports.args = [
  {
    ...
    "optional": false,
    "type": "jsonfile",
    "description": "json file generated by create-move-analysis"
  },
  { "name": "amount",
    "optional": true,
    "type": "int",
...
exports.description = "Executes plan created by create-move-analysis task.";
exports.selfTests = ["arango", "db", "coordinatorConnection"];
exports.requires = "3.3.23 - 3.11.99";
exports.info = `
Executes operations that have been calculated by the create-move-analysis task. 
