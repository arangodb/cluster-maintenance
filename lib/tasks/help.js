...
exports.selfTests = [];
exports.info = `
Provides usage information and shows available tasks.
`;
...
exports.run = function (extra, args) {
  ...
  if (taskName === undefined || taskName === "help" || names.indexOf(taskName) < 0) {
    ...
    print();
    print("General Usage: ./maintenance.sh <taskname> [parameters]");
    print("   Help Usage: ./maintenance.sh help <taskname>");
    let lastGroup;
